...
public class GMKeyCommand extends GMCommand {
     ...
     */
    public static int GMKeyEventFocusLeft_down = 014;
    /**
     * GMKeyEventFocusRight:发送调焦增加的命令
     */
    public static int GMKeyEventFocusLeft_up = 013;


    public static int GMKeyEventFocusRight_down = 022;
    /**
     * GMKeyEventFocusRight:发送调焦增加的命令
     */
    public static int GMKeyEventFocusRight_up = 021;
