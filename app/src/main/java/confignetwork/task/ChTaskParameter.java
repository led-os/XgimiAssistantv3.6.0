...
public class ChTaskParameter implements IChTaskParameter {
	...
	private int mChResultOneLen;
	private int mChResultMacLen;
	private int mChResultIpLen;
	private int mChResultTotalLen;
	...
	@Override
	public int getChResultOneLen() {
		return mChResultOneLen;
	}

	@Override
	public int getChResultMacLen() {
		return mChResultMacLen;
	}

	@Override
	public int getChResultIpLen() {
		return mChResultIpLen;
	}

	@Override
	public int getChResultTotalLen() {
		return mChResultTotalLen;
	}
