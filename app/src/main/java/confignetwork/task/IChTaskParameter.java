...
public interface IChTaskParameter {
	...
	/**
	 * get total repeat time for executing ch task
	 * @return total repeat time for executing ch task
	 */
	int getTotalRepeatTime();
	
	/**
	 * the length of the Ch result 1st byte is the total length of ssid and
	 * password, the other 6 bytes are the device's bssid
	 */
	
	/**
	 * get chResult length of one
	 * @return length of one
	 */
	int getChResultOneLen();
	
	/**
	 * get chResult length of mac
	 * @return length of mac
	 */
	int getChResultMacLen();
	
	/**
	 * get chResult length of ip
	 * @return length of ip
	 */
	int getChResultIpLen();
	
	/**
	 * get chResult total length
	 * @return total length
	 */
	int getChResultTotalLen();
