package confignetwork.protocol;


import java.net.InetAddress;

import confignetwork.task.IChGenerator;
import confignetwork.util.ByteUtil;


public class ChGenerator implements IChGenerator {

    private final byte[][] mGcBytes2;
    private final byte[][] mDcBytes2;

    /**
     * Constructor of ChGenerator, it will cost some time(maybe a bit
     * much)
     *
     ...
     */
    public ChGenerator(String apSsid, String apBssid, String apPassword, InetAddress inetAddress, boolean isSsidHiden) {
        // generate guide code
