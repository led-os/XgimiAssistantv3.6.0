...
public class TVPlayFragment extends BaseFragment implements View.OnClickListener,SwipeRefreshLayout.OnRefreshListener{
    ...
    private void initView(View view) {
        ...
        mMovieAdapter = new AllMovieAdapter(getActivity(), mDatas,true,"电视剧");
        ...
        mMovieAdapter.setLisener(new OnitemClick() {
            ...
            public void onClickLisener(String name,String id,String type) {
                ...
                SaveData.getInstance().mSoucePage="3";
    ...
    private void initLocal() {
        String readHomeJson = app.readHomeJson("tvplayfragment");
...
//                    App app = (App) getActivity().getApplicationContext();
                    String tvplayfragment=new Gson().toJson(channels);
                    app.savaHomeJson("tvplayfragment",tvplayfragment);
                }
                loadHome(channels);
            }else {
                if(HttpUrl.isNetworkConnected(getActivity())) {
