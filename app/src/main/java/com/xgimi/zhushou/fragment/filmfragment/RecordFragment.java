...
public class RecordFragment extends BaseFragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    RecyclerView recyclerView;
    TextView tv_channel;
    private List<AllMovie.DataBean> mDatas = new ArrayList<>();
    private int mPage = 1;
    private int mPageSize = 30;
    private String mCategory = "纪录片";
    private int msorts;
    ...
    private void initView(View view) {
        ...
        mMovieAdapter = new AllMovieAdapter(getActivity(), mDatas, true, "纪录片");
        ...
        mMovieAdapter.setLisener(new OnitemClick() {
            ...
            public void onClickLisener(String name, String id, String type) {
                ...
                SaveData.getInstance().mSoucePage = "6";
    ...
    private void initLocal() {
        String readHomeJson = app.readHomeJson("recordfragment");
...
//                    App app = (App) getActivity().getApplicationContext();
                    String recordfragment = new Gson().toJson(channels);
                    app.savaHomeJson("recordfragment", recordfragment);
                }
                loadHome(channels);
            } else {
                if (HttpUrl.isNetworkConnected(getActivity())) {
