...
public class ComicFragment extends BaseFragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView(View view) {
        ...
        mMovieAdapter = new AllMovieAdapter(getActivity(), mDatas, true, "动漫");
        ...
        mMovieAdapter.setLisener(new OnitemClick() {
            ...
            public void onClickLisener(String name, String id, String type) {
                ...
                SaveData.getInstance().mSoucePage = "5";
    ...
    private void initLocal() {
        String readHomeJson = app.readHomeJson("comicfragment");
...
//                    App app = (App) getActivity().getApplicationContext();
                    String comicfragment = new Gson().toJson(channels);
                    app.savaHomeJson("comicfragment", comicfragment);
                }
                loadHome(channels);
            } else {
                if (HttpUrl.isNetworkConnected(getActivity())) {
