 ...
 */
public class yuanxing extends ImageView {
	...
	public yuanxing(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public yuanxing(Context context, AttributeSet attrs, int defStyle) {
