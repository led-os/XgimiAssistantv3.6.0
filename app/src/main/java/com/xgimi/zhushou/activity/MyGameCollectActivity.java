 ...
 */
public class MyGameCollectActivity extends BaseActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_game_collect);
        initExtra();
        initView();
    ...
    private void initView() {
        ...
        title.setText("游戏收藏");
        adapter=new MyCollectAppAdapter(0,MyGameCollectActivity.this, mData);
...
//                menu.addMenuItem(openItem);
    ...
    private void jump(int position){
        Intent intent=new Intent(MyGameCollectActivity.this, ApplyDetailActivity.class);
        ...
        public void onNext(AppCollect appCollect) {
            if(appCollect!=null&&appCollect.data!=null){
                if(appCollect.code==200&&appCollect.data.equals("success")){
                    Toast.makeText(MyGameCollectActivity.this, "取消收藏", Toast.LENGTH_SHORT).show();
                }
            }
        }
    };
