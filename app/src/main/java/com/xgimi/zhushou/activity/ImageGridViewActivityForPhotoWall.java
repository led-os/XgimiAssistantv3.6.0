...
public class ImageGridViewActivityForPhotoWall extends BaseActivity implements OnClickListener {
    ...
    private Handler mFinishHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                ImageGridViewActivityForPhotoWall.this.setResult(1, intent);
                ImageGridViewActivityForPhotoWall.this.finish();
            }
        }
    };
...
//	private List<ImageInfo> childPathList;
    ...
    private void initView() {
        ...
        yunAdapter = new YunLocalimageGridAdapter(this, childPathList, true);
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (mPosition != -1) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                                PageViewImage page = new PageViewImage(ImageGridViewActivityForPhotoWall.this, path, position);
                                page.show();
                                isShow = true;
                        }
                    });
                    ToosUtil.getInstance().addEventUmeng(ImageGridViewActivityForPhotoWall.this, "event_local_picture");
                } else {
