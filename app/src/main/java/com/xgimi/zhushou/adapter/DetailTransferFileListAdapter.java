 ...
 */
public class DetailTransferFileListAdapter extends BaseAdapter{
    ...
    public DetailTransferFileListAdapter(Context context, int item, List<Map<String, Object>> fileMapGroup) {
