 ...
 */
public class MVRecoPoPListAdapter extends BaseAdapter {
    private Activity mActivity;
    private List<MVList.data> mDatas;
    private int mPostion;
    public String url="http://image.t.xgimi.com";
    public MVRecoPoPListAdapter( Activity activity, List<MVList.data> data){
...
//        this.mPostion=postion;
    ...
    @Override
    public MVList.data getItem(int arg0) {
        // TODO Auto-generated method stub
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        ImageLoaderUtils.display(mActivity,vh.iv,url+mDatas.get(arg0).mv_thumb);
