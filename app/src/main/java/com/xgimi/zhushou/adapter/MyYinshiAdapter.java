 ...
 */
public class MyYinshiAdapter extends BaseAdapter{
    private MyYinShiBeen mData;
    private Context context;
    public MyYinshiAdapter(MyYinShiBeen mData, Context context){
        this.mData=mData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(mData.data.get(position).img!=null&&!mData.data.get(position).img.equals("")){
